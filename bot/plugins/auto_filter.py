...
async def auto_filter(bot, update):
    ...
    if filters:
        results.append(
                [
                    InlineKeyboardButton("☮ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 ☮", url="https://t.me/joinchat/4oT3WpDqfRFiMTZl"),
                    InlineKeyboardButton("☮ 𝙝𝙙 𝙢𝙤𝙫𝙞𝙚𝙨 ☮", url="https://t.me/joinchat/WjcMRPNkHJAxZDk1"),
                ]
            )
    ...
    if len(results) == 0: # double check
        ...
        try:
            await bot.send_photo(
                ...
                photo="https://telegra.ph/file/8b174634c3ab136aef0ce.jpg",
                caption=f"""<b>𝐆𝐫𝐨𝐮𝐩:- @MOVIESWORLD52 
